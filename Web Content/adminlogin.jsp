...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      ...
      <div class="cta">
        <a href="adminlogin.jsp" class="scrollto">Login</a>
      </div>
    </div>
  </section>
...
<article class="card-body">
	...
	<s:form action="loginuser.action" theme="simple">
	<div class="form-group">
	<div class="input-group">
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
		<s:textfield name="username" class="form-control" placeholder="Username" required="true"/>
	</div> <!-- input-group.// -->
	</div> <!-- form-group// -->
	<div class="form-group">
	<div class="input-group">
