...
<body>
 ...
 <span style="border-bottom-width: 1px; border-bottom-style: solid; padding-bottom: 2px">First Lets Find Your Account</span>
  </div>
...
<s:actionmessage class="text-danger text-left mt-3 " />
  ...
  <article class="card-body">
     <s:form action="sndemail" method="post" theme="simple">
		
			
		
		<div class="form-group text-lg-left">
		<label> Registered Email address</label>
		<s:textfield name="email" type="email" placeholder="Email Id" class="form-control" required="true"/>
	</div> 
		<br>
