...
<body>
 ...
 <span style="border-bottom-width: 1px; border-bottom-style: solid; padding-bottom: 2px">Now You Can Set A New Password</span>
  </div>
...
<s:actionmessage class="text-danger text-left mt-3 " />
  ...
  <article class="card-body">
     <s:form name="passForm" action="UpdatePass" method="post" theme="simple" onsubmit="return passval()" >
		...
		<div class="col form-group">
			<label>Confirm Password</label>
		  	<s:password name="cpassword"  class="form-control" required="true"/>
		</div> <!-- form-group end.// -->
	</div> <!-- form-row end.// -->
...
function passval()
{
	...
	var cpass = document.forms["passForm"]["cpassword"].value;
