...
<article class="card-body">
	...
	<hr>
	<p class="text-danger text-center"><s:actionmessage class="text-danger text-center" /></p>
	<s:form action="loginprocess" method="post" theme="simple">
	<div class="form-group">
	<div class="input-group">
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
		<s:textfield name="email" class="form-control" placeholder="Email" type="email" required="true"/>
	</div> <!-- input-group.// -->
	</div> <!-- form-group// -->
	<div class="form-group">
	<div class="input-group">
	    ...
	    <s:password name="password" class="form-control" placeholder="*********" type="password" required="true"/>
	</div> <!-- input-group.// -->
	</div> <!-- form-group// -->
	<div class="form-group">
	<button type="submit" class="btn btn-primary btn-block"> Login  </button>
	</div> <!-- form-group// -->
	<p class="text-center"><a href="forgot.jsp"  class="btn">Forgot password ?</a></p>
	</s:form>
</article>
</div> <!-- card.// -->
</aside>
